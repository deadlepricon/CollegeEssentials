...
@CssImport("./themes/myapp/Privacy.css")
...
public class PrivacyPolicies extends VerticalLayout{
    ...
    public PrivacyPolicies(){
        ...
        header.addClassName("privacy-title");
        
        TextArea policies = new TextArea("");
        policies.addClassName("privacy-box");
        policies.setValue(
            "Privacy Policy for College Essentials"
            ...
            +"Company (referred to as either \"the Company\", \"We\", \"Us\" or \"Our\" in this Agreement) refers to College Essentials."
            ...
            +"Website refers to College Essentials, accessible from https://localhost.com"
            ...
            +"By email: College@Essentials.com"
